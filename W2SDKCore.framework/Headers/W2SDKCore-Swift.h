...
#ifndef W2SDKCORE_SWIFT_H
#define W2SDKCORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="W2SDKCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSNumber;

SWIFT_CLASS("_TtC9W2SDKCore19AcuantCameraOptions")
@interface AcuantCameraOptions : NSObject
...
SWIFT_CLASS("_TtC9W2SDKCore20AcuantCameraTextView")
@interface AcuantCameraTextView : CATextLayer
...
SWIFT_PROTOCOL("_TtP9W2SDKCore22AppOrientationDelegate_")
@protocol AppOrientationDelegate
- (void)onAppOrientationLockChangedWithMode:(UIInterfaceOrientationMask)mode;
@end

@class Image;
@class NSString;

SWIFT_PROTOCOL("_TtP9W2SDKCore21CameraCaptureDelegate_")
...
SWIFT_CLASS("_TtC9W2SDKCore23CameraCornerOverlayView")
...
SWIFT_CLASS("_TtC9W2SDKCore25CameraDocumentOverlayView")
...
SWIFT_CLASS("_TtC9W2SDKCore16CaptureConstants")
...
SWIFT_PROTOCOL("_TtP9W2SDKCore21FrameAnalysisDelegate_")
...
SWIFT_PROTOCOL("_TtP9W2SDKCore23DocumentCaptureDelegate_")
...
SWIFT_CLASS("_TtC9W2SDKCore24DocumentCameraController")
@interface DocumentCameraController : UIViewController <DocumentCaptureDelegate, FrameAnalysisDelegate>
+ (DocumentCameraController * _Nonnull)getCameraControllerWithDelegate:(id <CameraCaptureDelegate> _Nonnull)delegate cameraOptions:(AcuantCameraOptions * _Nonnull)cameraOptions SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9W2SDKCore22DocumentCaptureSession")
...
+ (DocumentCaptureSession * _Nonnull)getDocumentCaptureSessionWithDelegate:(id <DocumentCaptureDelegate> _Nullable)delegate frameDelegate:(id <FrameAnalysisDelegate> _Nonnull)frameDelegate autoCapture:(BOOL)autoCapture captureDevice:(AVCaptureDevice * _Nullable)captureDevice SWIFT_WARN_UNUSED_RESULT;
- (void)enableCapture;
- (void)startRunning;
...
@interface UIDevice (SWIFT_EXTENSION(W2SDKCore))
...
typedef SWIFT_ENUM(NSInteger, W2LicenceClientError, open) {
  ...
  W2LicenceClientErrorInvalidUrl = 4,
  W2LicenceClientErrorInvalidRequest = 5,
};
